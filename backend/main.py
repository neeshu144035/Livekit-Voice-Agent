...
from backend.models import (
    ...
    AgentModel, CallModel, TranscriptModel,
    WebhookLogModel, ChatAgentModel, FunctionModel, PhoneNumberModel,
    get_database,
)
...
async def update_agent(agent_id: int, agent_update: AgentUpdate, db: Session = Depends(get_database)):
    ...
    if agent_update.custom_params is not None:
        ...
        # Preserve builtin_functions if the frontend update doesn't explicitly include them
